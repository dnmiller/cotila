...
static_assert(m1(0, 1) == 2.);
static_assert(m1(0, 2) == 3.);
static_assert(m1(1, 0) == 4.);
static_assert(m1(1, 1) == 5.);
static_assert(m1(1, 2) == 6.);
static_assert(m1(2, 0) == 7.);
static_assert(m1(2, 1) == 8.);
static_assert(m1(2, 2) == 9.);

// Type deduction
constexpr matrix m2 = {{{1.,2.}}};
static_assert(m2.row_size == 1u, "number of rows");
static_assert(m2.column_size == 2u, "number of columns");
...
// // // Vandermonde matrix for [1, 2, 3, 4, 5]
// // constexpr matrix v5 = {
// //     {{  1.,   1.,  1., 1., 1.},
// //      { 16.,   8.,  4., 2., 1.},
// //      { 81.,  27.,  9., 3., 1.},
...
// // static_assert(v5 * x5 == y5, "multiplication");
